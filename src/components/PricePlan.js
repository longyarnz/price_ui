...
export default function PricePlan() {
  const submit = () => console.log('Plan submitted!');
  ...
  return (
    <div>
      <PricingTable highlightColor='#1976D2'>
        ...
        <PricingSlot onClick={submit} buttonText='UPGRADE' title='Bronze' priceText='₦24/month'>
        ...
        <PricingSlot onClick={submit} buttonText='UPGRADE' title='Silver' priceText='₦99/month'>
          <PricingDetail> <b>100</b> projects</PricingDetail>
          <PricingDetail> <b>30 GB</b> storage</PricingDetail>
          <PricingDetail> <b>Unlimited</b> users</PricingDetail>
          <PricingDetail> <b>Time tracking</b></PricingDetail>
        </PricingSlot>
        <PricingSlot onClick={submit} buttonText='UPGRADE' title='Gold' priceText='₦200/month'>
